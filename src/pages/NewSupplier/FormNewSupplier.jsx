    ...
    <>
      <form className='mt-10 p-3 w-1/2'>
        ...
        <section className='mt-3'>
          <label className={`label-required ${errors.company && 'span-alert'}`}>
            Razón Social
          </label>
          <div className=''>
            <input
        ...
        <section className='flex space-x-6 justify-between items-center'>
          ...
          {/* INPUT STATE */}
          <div className='mt-3 w-3/5'>
            <label className={`label-required ${errors.state && 'span-alert'}`}>
              Estado
            </label>
            <div>
              <input
          ...
          <div className='mt-3 w-3/5'>
            <label className={`label-required ${errors.city && 'span-alert'}`}>
              Ciudad
            </label>
            <div>
              <input
        ...
        {/* INPUT ADDRESS */}
        <section className='mt-3'>
          <label className={`label-required ${errors.address && 'span-alert'}`}>
            Dirección
          </label>
          <div className=''>
            <input
