    ...
    const getSuppId = () => {
      fetch(`https://dev.hubmine.mx/api/suppliers/details?supplier-id=${id}`)
        ...
        .then((json) => {
          ...
          setValue('postal_code', json[0].location.postal_code);
          setValue('direction', json[0].location.direction);
          setValue('exterior_num', json[0].location.exterior_num);
          setValue('interior_num', json[0].location.interior_num);
          setValue('colony', json[0].location.colony);
